...
def find_board(img):
    ...
    for contour in contours:
        ...
        if len(approx) == 4:
            ...
            break
    if location is None:
        raise Exception("Could not find Sudoku board.")
...
# Read image
image_path = r'C:\Users\Katana\Desktop\IP-Pro\sudoku3   .jpg'  # Use raw string to avoid unicode escape errors
...
try:
    ...
    print(f"Solution doesn't exist. Model misread digits: {e}")
